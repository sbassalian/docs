...
sidebarTitle: "Bulk update affiliates"
openapi: "PATCH /campaign_affiliates/bulk"
description: "Set affiliate codes for many creators in one request."
---

Built for spoken-code migrations: keep the codes creators already use when you move them onto a revenue campaign.
...
If some rows fail, the API returns `422` with an `errors` list. Rows that succeeded are still saved.
