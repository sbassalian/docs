...
description: "Performance totals for each ambassador over a date range."
---

Includes revenue, commission, order counts, refund amounts and clicks, grouped by affiliate.
