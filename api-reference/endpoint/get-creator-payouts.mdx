...
description: "Returns a paginated list of creator payouts for the authenticated organization. Includes credit fields and a `credits_only` filter for organizations that use creator credits."
---
