...
description: "This endpoint allows you to retrieve various statistics data from the Growi platform. Replace `{endpoint}` with the specific stats endpoint you want to access."
---
